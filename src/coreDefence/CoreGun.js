class CoreGun extends Gun{
    ...
    drawGun(ctx) {
        ...
        Setups.draw.arc(this.position, 50, this.angleControll.getVal() + Math.PI - 0.3, this.angleControll.getVal() + Math.PI + 0.3, new Vector2(0, 0), Color4.colorFromHex('#00FF00'));
    }
}