var ZombieShoter = /** @class */ (function () {
    function ZombieShoter() {
    }
    ZombieShoter.prototype.Init = function () {
        this.killed = 0;
        this.score = 0;
        this.money = 0;
        this.health = 100;
    ...
    ZombieShoter.prototype.Update = function (timeDelta) {
    ...
    ZombieShoter.prototype.Draw = function (ctx) {
        for (var item in this.zombies) {
        ...
        Setups.I.Draw.TextFill({ str: "Killed: " + this.killed, position: new Vector2(10, 29), color: Color4.Gray(), fontName: "serif", fontSize: 18, origin: new Vector2(-1, 0) });
    ...
    //-------------
    ZombieShoter.prototype.SpawnZombie = function () {
    ...
    ZombieShoter.prototype.HitPlayer = function (power) {
        this.health -= power;
    };
    return ZombieShoter;
}());
//# sourceMappingURL=ZombieShoter.js.map