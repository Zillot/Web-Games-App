...
class StandartParams {
    ...
    public Normilize(): void {
        if (this.position == null) { throw "position can not be null"; }
        if (this.origin == null) { this.origin = new Vector2(0, 0); }
        if (this.color == null) { this.color = new Color4(0, 0, 0, 1); }
        if (this.angle == null) { this.angle = 0; }
        if (this.scale == null) { this.scale = new Vector2(1, 1); }
...
class FillRectParams extends StandartParams {
    public size: Vector2;
    ...
    public Normilize(): void {
        super.Normilize();
        if (this.size == null) { this.size = new Vector2(0, 0); }
    }
}

class StrokeRectParams extends FillRectParams {
...
class FillCircleParams extends StandartParams {
    ...
    public Normilize(): void {
        super.Normilize();
        if (this.radius == null) { throw "radius can not be null"; }
    }
}

class StrokeCircleParams extends FillCircleParams {
    public thickness: number;
...
class FillArcParams extends FillCircleParams {
    public radius: number;
...
class StrokeArcParams extends FillArcParams {
    public thickness: number;
...
class TextParams extends StandartParams {
    public str: string;
...
class LineParams {
    ...
    public Normilize(): void {
        if (this.pointFrom == null) { throw "pointFrom can not be null"; }
        if (this.pointTo == null) { throw "pointTo can not be null"; }
        if (this.thickness == null) { this.thickness = 1; }
        if (this.color == null) { this.color = new Color4(0, 0, 0, 1); }
    }
}