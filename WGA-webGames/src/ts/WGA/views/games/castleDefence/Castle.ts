...
export class Castle extends Unit {
    ...
    public Draw(exDraw: ExDraw): void {
        exDraw.DrawTower(this.Position, new Vector2(80, 100), this.Level, this.Color1, this.Color2, 1);
        exDraw.DrawTower(this.Position.ADD(new Vector2(-40, 0)), new Vector2(100, 50), this.Level, this.Color1, this.Color2, 1);
        exDraw.DrawTower(this.Position.ADD(new Vector2(40, 0)), new Vector2(100, 50), this.Level, this.Color1, this.Color2, 1);

        Draw.I.TriangleFill(<FillTriangleParams>{ position: this.Position.ADD(new Vector2(0, -120)), size: new Vector2(80, 40), origin: new Vector2(0, 1), color: this.Color2 });
    }
}
