...
export class MainPage extends Page {
    ...
    public Draw() {
        ...
        this._draw.TextFill(<TextParams>{ str: 'Web games app', position: new Vector2(Data.I.Center.X, 100), color: Color4.White, fontSize: 50, origin: new Vector2(0) });
        this._draw.TextFill(<TextParams>{ str: 'Main menu', position: new Vector2(Data.I.Center.X, 150), color: Color4.White, fontSize: 30, origin: new Vector2(0) });
